...
function Invoke-Phase1 {
    ...
    $count = 0
    $select = 'id,displayName,description,mail,mailEnabled,mailNickname,securityEnabled,groupTypes,membershipRule,membershipRuleProcessingState,onPremisesSyncEnabled,onPremisesLastSyncDateTime,createdDateTime,proxyAddresses,visibility'
