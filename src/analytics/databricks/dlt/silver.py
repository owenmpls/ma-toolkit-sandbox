...
def _bronze_table_exists(entity_type):
    """Check if a bronze table exists in Unity Catalog."""
    try:
        return spark.catalog.tableExists(f"matoolkit_analytics.bronze.{entity_type}")
    except Exception:
        return False
...
# Users
# ============================================================================
if _bronze_table_exists("entra_users"):
...
# Groups
# ============================================================================
if _bronze_table_exists("entra_groups"):
...
# Group Members (Entra)
# ============================================================================
if _bronze_table_exists("entra_group_members"):
...
# ============================================================================
if _bronze_table_exists("entra_contacts"):
...
# Mailboxes
# ============================================================================
if _bronze_table_exists("exo_mailboxes"):
...
# EXO Contacts
# ============================================================================
if _bronze_table_exists("exo_contacts"):
...
# Distribution Groups
# ============================================================================
if _bronze_table_exists("exo_distribution_groups"):
...
# ============================================================================
if _bronze_table_exists("exo_unified_groups"):
...
# EXO Group Members
# ============================================================================
if _bronze_table_exists("exo_group_members"):
...
# Mailbox Statistics
# ============================================================================
if _bronze_table_exists("exo_mailbox_statistics"):
...
# ============================================================================
if _bronze_table_exists("spo_sites"):
...
# OneDrive Usage
# ============================================================================
if _bronze_table_exists("onedrive_usage"):
